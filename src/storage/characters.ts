...
export function newCharacter(
  ...
  return {
    ...
    identity: { lineage: '', family: '', concept: '', entanglement: 0, rolePath: '', shortTerm1: '', shortTerm2: '', longTerm: '' },
    webhookUrl: '',
...
export function normalizeCharacter(raw: Partial<Character> & Pick<Character, 'id' | 'templateId' | 'name'>): Character {
  ...
  return {
    ...
    updatedAt: now,
    ...raw,
    identity: { ...{ lineage: '', family: '', concept: '', entanglement: 0, rolePath: '', shortTerm1: '', shortTerm2: '', longTerm: '' }, ...raw.identity },
