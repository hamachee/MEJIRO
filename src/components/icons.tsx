...
/** Bootstrap Icons "arrow-clockwise" — reset (mirror of arrow-counterclockwise/undo, not the same glyph reused). */
export function IconArrowClockwise(props: SVGProps<SVGSVGElement>) {
  return (
    <Icon viewBox="0 0 16 16" fill="currentColor" stroke="none" {...props}>
      <path
        fillRule="evenodd"
